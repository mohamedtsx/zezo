...
const getCv = () => {
  ...
  a.href = "ressources/devops-abdelaziz-hasan.pdf";
  a.setAttribute("download", "devops-abdelaziz-hasan.pdf");
...
const getLinkedin = () => {
  ...
  const a = document.createElement("a");
  a.href = "www.linkedin.com/in/abdelaziz-hasan";
  a.setAttribute("target", "blank");
  a.click();
};
...
const getGithub = () => {
  ...
  const a = document.createElement("a");
  // TODO: UPDATE THIS TO ZEZO ONE
  a.href = "https://github.com/mohamedtsx";
  a.setAttribute("target", "blank");
  a.click();
};
